...
```
#### Será que há muitos salários discrepantes puxando a média pra cima de tal forma que deixe de representar brm a amostra? Vamos verificar o comportamento no caso da mediana:
```{r}
